    ...
    <body>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <div class="new-arrival-container">
                        ...
                        <img id='a1' src="img/new-arrival-1.jpg" alt="New Arrival 1" class="img-responsive">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <div class="new-arrival-container">
                        ...
                        <img id='a2' src="img/new-arrival-2.jpg" alt="New Arrival 2" class="img-responsive">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <div class="new-arrival-container">
                        ...
                        <img id='a3' src="img/new-arrival-3.jpg" alt="New Arrival 3" class="img-responsive">
                    </div>
                </div>
            </div>
        ...
        <section class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a4' src="img/men-1.jpg" alt="Men fashion 1" class="img-fashion gold-border">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a5' src="img/men-2.jpg" alt="Men fashion 2" class="img-fashion gold-border">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a6' src="img/men-3.jpg" alt="Men fashion 3" class="img-fashion gold-border">
                </div>
            </div><hr>
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a7' src="img/product-type-1.jpg" alt="Women fashion 1" class="img-fashion gold-border">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a8' src="img/women-2.jpg" alt="Women fashion 2" class="img-fashion gold-border">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 margin-bottom-10 text-center">
                    <img id='a9' src="img/product-type-2.jpg" alt="Women fashion 3" class="img-fashion gold-border">
                </div>
            </div>
        ...
        <script>
            ...
            ajax.onreadystatechange = () => {
                if (ajax.readyState == 4 && ajax.status == 200) {
                    ...
                    let dataJsonObj  = JSON.parse(jsonData);

                    let itemStore = new Array(); 
                    ...
                    for (let i in dataJsonObj) {
                        if (dataJsonObj[i].category.name == 'clothes' || dataJsonObj[i].category.name == 'Shoes') {
                            itemStore.push(dataJsonObj[i]);
                        }
                    }

                    console.log(itemStore);

                    for (let imgs in imagesArrivael) {
                        let random = Math.floor(Math.random() * 10);
                        imagesArrivael[imgs].src = itemStore[random].images[0];
                    }
                } 
            }
